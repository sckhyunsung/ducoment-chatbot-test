...
# --- Text Splitter: 최신/신형/구버전 순서로 폴백 ---
try:
    from langchain_text_splitters import RecursiveCharacterTextSplitter  # 최신(권장)
except ImportError:
    try:
        from langchain.text_splitters import RecursiveCharacterTextSplitter  # 신형 네임스페이스
    except ImportError:
        from langchain.text_splitter import RecursiveCharacterTextSplitter  # 구버전

# --- VectorStore: FAISS는 community 네임스페이스 우선 ---
try:
    from langchain_community.vectorstores import FAISS
except ImportError:
    from langchain.vectorstores import FAISS  # 아주 구버전 호환

# --- LLM / Embeddings: langchain_openai 사용 ---
from langchain_openai import OpenAIEmbeddings, ChatOpenAI

# --- Loaders & Histories ---
from langchain_community.document_loaders import (
    PyPDFLoader, TextLoader, CSVLoader, UnstructuredWordDocumentLoader,
    UnstructuredExcelLoader, UnstructuredPowerPointLoader, UnstructuredHTMLLoader
)
from langchain_community.chat_message_histories import ChatMessageHistory

from langchain.prompts import ChatPromptTemplate

# --- Document 스키마: core로 이동(폴백 제공) ---
try:
    from langchain_core.documents import Document
except ImportError:
    from langchain.schema import Document  # 구버전 호환
